$(function() {
    ...
    $('.hamburger').on('click',function(){
        ...
        $(".header-top-mid ul").toggleClass('is-active');
    });
    $(document).on("click",function(event){
        if( $(event.target).closest(".header-top-mid ul,.hamburger").length )return;
        $('.hamburger').removeClass('is-active');
        $(".header-top-mid ul").removeClass('is-active');
